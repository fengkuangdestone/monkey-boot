package com.monkeyframework.boot.jetty.spring;
...
import com.monkeyframework.boot.jetty.core.WebappContextAttribute;
import com.monkeyframework.boot.utils.ApplicationUtils;
...
public class SpringContainer implements Container {
    ...
    public static final String DEFAULT_SPRING_CONFIG = "classpath*:META-INF/monkey/monkey-boot-jetty-spring.xml";
	...
	public void start() {
        ...
        try {
            ...
            server.start();
            server.join();
            logger.warn("monkey Boot " + Server.getVersion() + " Success !");
        } catch (Exception e) {
